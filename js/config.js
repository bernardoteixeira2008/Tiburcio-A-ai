...
const CONFIG = {
  ...
  PRODUTOS: [
    ...
    // ---------------- SORVETES 1 LITRO ----------------
    {
      ...
      maxSabores: 1,
      sabores: [
        { nome: "Ninho Trufado", imagem: "sabor-ninho-trufado.jpg" },
        { nome: "Napolitano", imagem: "sabor-napolitano.jpg" },
        { nome: "Nutella", imagem: "sabor-nutella.jpg" },
        { nome: "Ninho com Pistache", imagem: "sabor-ninho-pistache.jpg" },
        { nome: "Açaí", imagem: "sabor-acai.jpg" },
        { nome: "Kinderovo", imagem: "sabor-kinderovo.jpg" },
        { nome: "Frutas Vermelhas", imagem: "sabor-frutas-vermelhas.jpg" },
      ],
      destaque: true,
    },
    ...
    // ---------------- SANDER ----------------
    {
      ...
      maxSabores: 1,
      sabores: [
        { nome: "Morango", imagem: "sabor-sander-morango.jpg" },
        { nome: "Açaí com Ninho", imagem: "sabor-sander-acai-ninho.jpg" },
        { nome: "Brigadeiro", imagem: "sabor-sander-brigadeiro.jpg" },
        { nome: "Coco", imagem: "sabor-sander-coco.jpg" },
      ],
      destaque: false,
    },
    ...
    // ---------------- PICOLÉS PREMIUM ----------------
    {
      ...
      maxSabores: 1,
      sabores: [
        { nome: "Brigadeiro", imagem: "sabor-picole-brigadeiro.jpg" },
        { nome: "Esquimó", imagem: "sabor-picole-esquimo.jpg" },
        { nome: "Tentação", imagem: "sabor-picole-tentacao.jpg" },
        { nome: "Pé de Moleque", imagem: "sabor-picole-pe-de-moleque.jpg" },
      ],
      destaque: false,
    },
  ],
